...
<form method="post" action="add_edit_process.php">
  ...
  <input type="checkbox" name="from_human_japanese" id="human_japanese" <? $item[0]['from_human_japanese'] == true ? 'echo checked="checked"' : '' ?> value="true" /> <label for="human_japanese">Is from Human Japanese</label><br />
